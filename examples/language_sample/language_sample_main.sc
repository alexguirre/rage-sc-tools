...
INT aIntByState[ENUM_TO_INT(STATE_COUNT)] // INT[4]

ENUM eTestEnum
    TEST_ENUM_0                     // 0
    TEST_ENUM_1 = ENUM_TO_INT(TEST_ENUM_0) + 1   // 1
    TEST_ENUM_2 = ENUM_TO_INT(TEST_ENUM_1) + 1   // 2
    TEST_ENUM_3 = ENUM_TO_INT(TEST_ENUM_2) + 1   // 3
ENDENUM

CONST INT TEST_INT_0 = ENUM_TO_INT(TEST_ENUM_3) - 1            // 2
CONST INT TEST_INT_1 = ENUM_TO_INT(TEST_ENUM_2) + TEST_INT_0   // 4
...
SCRIPT language_sample_main
    ...
    WHILE TRUE
        ...
        IF IS_CONTROL_PRESSED(0, INPUT_CONTEXT_SECONDARY) AND IS_CONTROL_JUST_PRESSED(0, INPUT_CONTEXT)
            nState = INT_TO_ENUM(eState, (ENUM_TO_INT(nState) + 1) % ENUM_TO_INT(STATE_COUNT))
        ENDIF
