namespace ScTools.Tests.ScriptLang.CodeGen
{
    ...
    public class CodeGenTests
    {
        ...
        [Fact]
        public void TestAddS16Optimization()
        {
            CompileMain(
            source: @"
                TEST(8 + 10000)
        ...
        [Fact]
        public void TestMulS16Optimization()
        {
            CompileMain(
            source: @"
                TEST(8 * 10000)
        ...
        [Fact]
        public void TestAddU8Optimization()
        {
            CompileMain(
            source: @"
                TEST(8 + 1)
        ...
        [Fact]
        public void TestMulU8Optimization()
        {
            CompileMain(
            source: @"
                TEST(8 * 1)
        ...
        [Fact]
        public void TestPushU8Optimization1()
        {
            CompileMain(
            source: @"
                TEST(8, 11 + 10)
        ...
        [Fact]
        public void TestPushU8Optimization2()
        {
            CompileMain(
            source: @"
                TEST(8, 11 + 10, 8)
        ...
        [Fact]
        public void TestPushU8Optimization3()
        {
            CompileMain(
            source: @"
                TEST(8, 11, 8 + 10)
