...
public sealed partial class RepeatStatement : BaseStatement, ILoopStatement
{
    ...
    public NameExpression Counter => (NameExpression)Children[1];
    ...
    public RepeatStatement(Token repeatKeyword, Token endrepeatKeyword, IExpression limit, NameExpression counter, IEnumerable<IStatement> body, Label? label)
