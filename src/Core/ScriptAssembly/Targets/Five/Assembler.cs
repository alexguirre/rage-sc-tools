...
public partial class Assembler : IDisposable
{
    ...
    private void ProcessInstruction(Parser.Instruction instruction)
    {
        ...
        {
            Opcode.NOP => instEmitter.EmitNop(),
            ...
            Opcode.PUSH_CONST_U8 => instEmitter.EmitPushConstU8(u8(0)),
            Opcode.PUSH_CONST_U8_U8 => instEmitter.EmitPushConstU8U8(u8(0), u8(1)),
            Opcode.PUSH_CONST_U8_U8_U8 => instEmitter.EmitPushConstU8U8U8(u8(0), u8(1), u8(2)),
            ...
            Opcode.NATIVE => instEmitter.EmitNative(u8(0), u8(1), u16(2)),
            Opcode.ENTER => instEmitter.EmitEnter(u8(0), u16(1), GetFunctionName()),
            ...
            Opcode.ARRAY_U8 => instEmitter.EmitArrayU8(u8(0)),
            Opcode.ARRAY_U8_LOAD => instEmitter.EmitArrayU8Load(u8(0)),
            Opcode.ARRAY_U8_STORE => instEmitter.EmitArrayU8Store(u8(0)),
            Opcode.LOCAL_U8 => instEmitter.EmitLocalU8(u8(0)),
            Opcode.LOCAL_U8_LOAD => instEmitter.EmitLocalU8Load(u8(0)),
            Opcode.LOCAL_U8_STORE => instEmitter.EmitLocalU8Store(u8(0)),
            Opcode.STATIC_U8 => instEmitter.EmitStaticU8(u8(0)),
            Opcode.STATIC_U8_LOAD => instEmitter.EmitStaticU8Load(u8(0)),
            Opcode.STATIC_U8_STORE => instEmitter.EmitStaticU8Store(u8(0)),
            Opcode.IADD_U8 => instEmitter.EmitIAddU8(u8(0)),
            Opcode.IMUL_U8 => instEmitter.EmitIMulU8(u8(0)),
            Opcode.IOFFSET => instEmitter.EmitIOffset(),
            Opcode.IOFFSET_U8 => instEmitter.EmitIOffsetU8(u8(0)),
            Opcode.IOFFSET_U8_LOAD => instEmitter.EmitIOffsetU8Load(u8(0)),
            Opcode.IOFFSET_U8_STORE => instEmitter.EmitIOffsetU8Store(u8(0)),
            Opcode.PUSH_CONST_S16 => instEmitter.EmitPushConstS16(s16(0)),
            Opcode.IADD_S16 => instEmitter.EmitIAddS16(s16(0)),
            Opcode.IMUL_S16 => instEmitter.EmitIMulS16(s16(0)),
            Opcode.IOFFSET_S16 => instEmitter.EmitIOffsetS16(s16(0)),
            Opcode.IOFFSET_S16_LOAD => instEmitter.EmitIOffsetS16Load(s16(0)),
            Opcode.IOFFSET_S16_STORE => instEmitter.EmitIOffsetS16Store(s16(0)),
            Opcode.ARRAY_U16 => instEmitter.EmitArrayU16(u16(0)),
            Opcode.ARRAY_U16_LOAD => instEmitter.EmitArrayU16Load(u16(0)),
            Opcode.ARRAY_U16_STORE => instEmitter.EmitArrayU16Store(u16(0)),
            Opcode.LOCAL_U16 => instEmitter.EmitLocalU16(u16(0)),
            Opcode.LOCAL_U16_LOAD => instEmitter.EmitLocalU16Load(u16(0)),
            Opcode.LOCAL_U16_STORE => instEmitter.EmitLocalU16Store(u16(0)),
            Opcode.STATIC_U16 => instEmitter.EmitStaticU16(u16(0)),
            Opcode.STATIC_U16_LOAD => instEmitter.EmitStaticU16Load(u16(0)),
            Opcode.STATIC_U16_STORE => instEmitter.EmitStaticU16Store(u16(0)),
            Opcode.GLOBAL_U16 => instEmitter.EmitGlobalU16(u16(0)),
            Opcode.GLOBAL_U16_LOAD => instEmitter.EmitGlobalU16Load(u16(0)),
            Opcode.GLOBAL_U16_STORE => instEmitter.EmitGlobalU16Store(u16(0)),
            Opcode.J => instEmitter.EmitJ(s16(0)),
            Opcode.JZ => instEmitter.EmitJZ(s16(0)),
            Opcode.IEQ_JZ => instEmitter.EmitIEqJZ(s16(0)),
            Opcode.INE_JZ => instEmitter.EmitINeJZ(s16(0)),
            Opcode.IGT_JZ => instEmitter.EmitIGtJZ(s16(0)),
            Opcode.IGE_JZ => instEmitter.EmitIGeJZ(s16(0)),
            Opcode.ILT_JZ => instEmitter.EmitILtJZ(s16(0)),
            Opcode.ILE_JZ => instEmitter.EmitILeJZ(s16(0)),
            Opcode.CALL => instEmitter.EmitCall(u24(0)),
            Opcode.GLOBAL_U24 => instEmitter.EmitGlobalU24(u24(0)),
            Opcode.GLOBAL_U24_LOAD => instEmitter.EmitGlobalU24Load(u24(0)),
            Opcode.GLOBAL_U24_STORE => instEmitter.EmitGlobalU24Store(u24(0)),
            Opcode.PUSH_CONST_U24 => instEmitter.EmitPushConstU24(u24(0)),
            Opcode.SWITCH => instEmitter.EmitSwitch(switchOps()),
            Opcode.STRING => instEmitter.EmitString(),
            Opcode.STRINGHASH => instEmitter.EmitStringHash(),
            ...
            Opcode.CALLINDIRECT => instEmitter.EmitCallIndirect(),
            Opcode.PUSH_CONST_M1 => instEmitter.EmitPushConstM1(),
            Opcode.PUSH_CONST_0 => instEmitter.EmitPushConst0(),
            Opcode.PUSH_CONST_1 => instEmitter.EmitPushConst1(),
            Opcode.PUSH_CONST_2 => instEmitter.EmitPushConst2(),
            Opcode.PUSH_CONST_3 => instEmitter.EmitPushConst3(),
            Opcode.PUSH_CONST_4 => instEmitter.EmitPushConst4(),
            Opcode.PUSH_CONST_5 => instEmitter.EmitPushConst5(),
            Opcode.PUSH_CONST_6 => instEmitter.EmitPushConst6(),
            Opcode.PUSH_CONST_7 => instEmitter.EmitPushConst7(),
            Opcode.PUSH_CONST_FM1 => instEmitter.EmitPushConstFM1(),
            Opcode.PUSH_CONST_F0 => instEmitter.EmitPushConstF0(),
            Opcode.PUSH_CONST_F1 => instEmitter.EmitPushConstF1(),
            Opcode.PUSH_CONST_F2 => instEmitter.EmitPushConstF2(),
            Opcode.PUSH_CONST_F3 => instEmitter.EmitPushConstF3(),
            Opcode.PUSH_CONST_F4 => instEmitter.EmitPushConstF4(),
            Opcode.PUSH_CONST_F5 => instEmitter.EmitPushConstF5(),
            Opcode.PUSH_CONST_F6 => instEmitter.EmitPushConstF6(),
            Opcode.PUSH_CONST_F7 => instEmitter.EmitPushConstF7(),
            Opcode.IBITTEST => throw new NotImplementedException(nameof(Opcode.IBITTEST)),
    ...
    private void FixInstruction(InstructionReference instruction, ImmutableArray<Parser.InstructionOperand> operands)
    {
        ...
        _ = opcode switch
        {
            Opcode.PUSH_CONST_U8 => instEmitter.EmitPushConstU8(u8(0, 1)),
            Opcode.PUSH_CONST_U8_U8 => instEmitter.EmitPushConstU8U8(u8(0, 1), u8(1, 2)),
            Opcode.PUSH_CONST_U8_U8_U8 => instEmitter.EmitPushConstU8U8U8(u8(0, 1), u8(1, 2), u8(2, 3)),
            Opcode.PUSH_CONST_U32 => instEmitter.EmitPushConstU32(u32(0, 1)),
            Opcode.NATIVE => instEmitter.EmitNative(u8NoCodeLabels(0), u8NoCodeLabels(1), u16NoCodeLabels(2)),
            Opcode.ENTER => instEmitter.EmitEnter(u8(0, 1), u16(1, 2), opcode.GetEnterFunctionName(CollectionsMarshal.AsSpan(instBuffer.GetBytes(instruction)))),
            Opcode.LEAVE => instEmitter.EmitLeave(u8(0, 1), u8(1, 1)),
            Opcode.ARRAY_U8 => instEmitter.EmitArrayU8(u8(0, 1)),
            Opcode.ARRAY_U8_LOAD => instEmitter.EmitArrayU8Load(u8(0, 1)),
            Opcode.ARRAY_U8_STORE => instEmitter.EmitArrayU8Store(u8(0, 1)),
            Opcode.LOCAL_U8 => instEmitter.EmitLocalU8(u8(0, 1)),
            Opcode.LOCAL_U8_LOAD => instEmitter.EmitLocalU8Load(u8(0, 1)),
            Opcode.LOCAL_U8_STORE => instEmitter.EmitLocalU8Store(u8(0, 1)),
            Opcode.STATIC_U8 => instEmitter.EmitStaticU8(u8(0, 1)),
            Opcode.STATIC_U8_LOAD => instEmitter.EmitStaticU8Load(u8(0, 1)),
            Opcode.STATIC_U8_STORE => instEmitter.EmitStaticU8Store(u8(0, 1)),
            Opcode.IADD_U8 => instEmitter.EmitIAddU8(u8(0, 1)),
            Opcode.IMUL_U8 => instEmitter.EmitIMulU8(u8(0, 1)),
            Opcode.IOFFSET_U8 => instEmitter.EmitIOffsetU8(u8(0, 1)),
            Opcode.IOFFSET_U8_LOAD => instEmitter.EmitIOffsetU8Load(u8(0, 1)),
            Opcode.IOFFSET_U8_STORE => instEmitter.EmitIOffsetU8Store(u8(0, 1)),
            Opcode.PUSH_CONST_S16 => instEmitter.EmitPushConstS16(s16(0, 1)),
            Opcode.IADD_S16 => instEmitter.EmitIAddS16(s16(0, 1)),
            Opcode.IMUL_S16 => instEmitter.EmitIMulS16(s16(0, 1)),
            Opcode.IOFFSET_S16 => instEmitter.EmitIOffsetS16(s16(0, 1)),
            Opcode.IOFFSET_S16_LOAD => instEmitter.EmitIOffsetS16Load(s16(0, 1)),
            Opcode.IOFFSET_S16_STORE => instEmitter.EmitIOffsetS16Store(s16(0, 1)),
            Opcode.ARRAY_U16 => instEmitter.EmitArrayU16(u16(0, 1)),
            Opcode.ARRAY_U16_LOAD => instEmitter.EmitArrayU16Load(u16(0, 1)),
            Opcode.ARRAY_U16_STORE => instEmitter.EmitArrayU16Store(u16(0, 1)),
            Opcode.LOCAL_U16 => instEmitter.EmitLocalU16(u16(0, 1)),
            Opcode.LOCAL_U16_LOAD => instEmitter.EmitLocalU16Load(u16(0, 1)),
            Opcode.LOCAL_U16_STORE => instEmitter.EmitLocalU16Store(u16(0, 1)),
            Opcode.STATIC_U16 => instEmitter.EmitStaticU16(u16(0, 1)),
            Opcode.STATIC_U16_LOAD => instEmitter.EmitStaticU16Load(u16(0, 1)),
            Opcode.STATIC_U16_STORE => instEmitter.EmitStaticU16Store(u16(0, 1)),
            Opcode.GLOBAL_U16 => instEmitter.EmitGlobalU16(u16(0, 1)),
            Opcode.GLOBAL_U16_LOAD => instEmitter.EmitGlobalU16Load(u16(0, 1)),
            Opcode.GLOBAL_U16_STORE => instEmitter.EmitGlobalU16Store(u16(0, 1)),
            Opcode.J => instEmitter.EmitJ(s16(0, 1)),
            Opcode.JZ => instEmitter.EmitJZ(s16(0, 1)),
            Opcode.IEQ_JZ => instEmitter.EmitIEqJZ(s16(0, 1)),
            Opcode.INE_JZ => instEmitter.EmitINeJZ(s16(0, 1)),
            Opcode.IGT_JZ => instEmitter.EmitIGtJZ(s16(0, 1)),
            Opcode.IGE_JZ => instEmitter.EmitIGeJZ(s16(0, 1)),
            Opcode.ILT_JZ => instEmitter.EmitILtJZ(s16(0, 1)),
            Opcode.ILE_JZ => instEmitter.EmitILeJZ(s16(0, 1)),
            Opcode.CALL => instEmitter.EmitCall(u24(0, 1)),
            Opcode.GLOBAL_U24 => instEmitter.EmitGlobalU24(u24(0, 1)),
            Opcode.GLOBAL_U24_LOAD => instEmitter.EmitGlobalU24Load(u24(0, 1)),
            Opcode.GLOBAL_U24_STORE => instEmitter.EmitGlobalU24Store(u24(0, 1)),
            Opcode.PUSH_CONST_U24 => instEmitter.EmitPushConstU24(u24(0, 1)),
            Opcode.SWITCH => instEmitter.EmitSwitch(switchOps()),
