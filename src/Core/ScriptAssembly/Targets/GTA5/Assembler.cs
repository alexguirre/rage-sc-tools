...
public partial class Assembler : IDisposable
{
    ...
    private void ProcessInstruction(Parser.Instruction instruction)
    {
        ...
        if (!Enum.TryParse<OpcodeV12>(instruction.Opcode.Lexeme.Span, out var opcode))
        {
        ...
        {
            OpcodeV12.NOP => instEmitter.EmitNop(),
            OpcodeV12.IADD => instEmitter.EmitIAdd(),
            OpcodeV12.ISUB => instEmitter.EmitISub(),
            OpcodeV12.IMUL => instEmitter.EmitIMul(),
            OpcodeV12.IDIV => instEmitter.EmitIDiv(),
            OpcodeV12.IMOD => instEmitter.EmitIMod(),
            OpcodeV12.INOT => instEmitter.EmitINot(),
            OpcodeV12.INEG => instEmitter.EmitINeg(),
            OpcodeV12.IEQ => instEmitter.EmitIEq(),
            OpcodeV12.INE => instEmitter.EmitINe(),
            OpcodeV12.IGT => instEmitter.EmitIGt(),
            OpcodeV12.IGE => instEmitter.EmitIGe(),
            OpcodeV12.ILT => instEmitter.EmitILt(),
            OpcodeV12.ILE => instEmitter.EmitILe(),
            OpcodeV12.FADD => instEmitter.EmitFAdd(),
            OpcodeV12.FSUB => instEmitter.EmitFSub(),
            OpcodeV12.FMUL => instEmitter.EmitFMul(),
            OpcodeV12.FDIV => instEmitter.EmitFDiv(),
            OpcodeV12.FMOD => instEmitter.EmitFMod(),
            OpcodeV12.FNEG => instEmitter.EmitFNeg(),
            OpcodeV12.FEQ => instEmitter.EmitFEq(),
            OpcodeV12.FNE => instEmitter.EmitFNe(),
            OpcodeV12.FGT => instEmitter.EmitFGt(),
            OpcodeV12.FGE => instEmitter.EmitFGe(),
            OpcodeV12.FLT => instEmitter.EmitFLt(),
            OpcodeV12.FLE => instEmitter.EmitFLe(),
            OpcodeV12.VADD => instEmitter.EmitVAdd(),
            OpcodeV12.VSUB => instEmitter.EmitVSub(),
            OpcodeV12.VMUL => instEmitter.EmitVMul(),
            OpcodeV12.VDIV => instEmitter.EmitVDiv(),
            OpcodeV12.VNEG => instEmitter.EmitVNeg(),
            OpcodeV12.IAND => instEmitter.EmitIAnd(),
            OpcodeV12.IOR => instEmitter.EmitIOr(),
            OpcodeV12.IXOR => instEmitter.EmitIXor(),
            OpcodeV12.I2F => instEmitter.EmitI2F(),
            OpcodeV12.F2I => instEmitter.EmitF2I(),
            OpcodeV12.F2V => instEmitter.EmitF2V(),
            OpcodeV12.PUSH_CONST_U8 => instEmitter.EmitPushConstU8(u8(0)),
            OpcodeV12.PUSH_CONST_U8_U8 => instEmitter.EmitPushConstU8U8(u8(0), u8(1)),
            OpcodeV12.PUSH_CONST_U8_U8_U8 => instEmitter.EmitPushConstU8U8U8(u8(0), u8(1), u8(2)),
            OpcodeV12.PUSH_CONST_U32 => instEmitter.EmitPushConstU32(u32(0)),
            OpcodeV12.PUSH_CONST_F => instEmitter.EmitPushConstF(f32(0)),
            OpcodeV12.DUP => instEmitter.EmitDup(),
            OpcodeV12.DROP => instEmitter.EmitDrop(),
            OpcodeV12.NATIVE => instEmitter.EmitNative(u8(0), u8(1), u16(2)),
            OpcodeV12.ENTER => instEmitter.EmitEnter(u8(0), u16(1), GetFunctionName()),
            OpcodeV12.LEAVE => instEmitter.EmitLeave(u8(0), u8(1)),
            OpcodeV12.LOAD => instEmitter.EmitLoad(),
            OpcodeV12.STORE => instEmitter.EmitStore(),
            OpcodeV12.STORE_REV => instEmitter.EmitStoreRev(),
            OpcodeV12.LOAD_N => instEmitter.EmitLoadN(),
            OpcodeV12.STORE_N => instEmitter.EmitStoreN(),
            OpcodeV12.ARRAY_U8 => instEmitter.EmitArrayU8(u8(0)),
            OpcodeV12.ARRAY_U8_LOAD => instEmitter.EmitArrayU8Load(u8(0)),
            OpcodeV12.ARRAY_U8_STORE => instEmitter.EmitArrayU8Store(u8(0)),
            OpcodeV12.LOCAL_U8 => instEmitter.EmitLocalU8(u8(0)),
            OpcodeV12.LOCAL_U8_LOAD => instEmitter.EmitLocalU8Load(u8(0)),
            OpcodeV12.LOCAL_U8_STORE => instEmitter.EmitLocalU8Store(u8(0)),
            OpcodeV12.STATIC_U8 => instEmitter.EmitStaticU8(u8(0)),
            OpcodeV12.STATIC_U8_LOAD => instEmitter.EmitStaticU8Load(u8(0)),
            OpcodeV12.STATIC_U8_STORE => instEmitter.EmitStaticU8Store(u8(0)),
            OpcodeV12.IADD_U8 => instEmitter.EmitIAddU8(u8(0)),
            OpcodeV12.IMUL_U8 => instEmitter.EmitIMulU8(u8(0)),
            OpcodeV12.IOFFSET => instEmitter.EmitIOffset(),
            OpcodeV12.IOFFSET_U8 => instEmitter.EmitIOffsetU8(u8(0)),
            OpcodeV12.IOFFSET_U8_LOAD => instEmitter.EmitIOffsetU8Load(u8(0)),
            OpcodeV12.IOFFSET_U8_STORE => instEmitter.EmitIOffsetU8Store(u8(0)),
            OpcodeV12.PUSH_CONST_S16 => instEmitter.EmitPushConstS16(s16(0)),
            OpcodeV12.IADD_S16 => instEmitter.EmitIAddS16(s16(0)),
            OpcodeV12.IMUL_S16 => instEmitter.EmitIMulS16(s16(0)),
            OpcodeV12.IOFFSET_S16 => instEmitter.EmitIOffsetS16(s16(0)),
            OpcodeV12.IOFFSET_S16_LOAD => instEmitter.EmitIOffsetS16Load(s16(0)),
            OpcodeV12.IOFFSET_S16_STORE => instEmitter.EmitIOffsetS16Store(s16(0)),
            OpcodeV12.ARRAY_U16 => instEmitter.EmitArrayU16(u16(0)),
            OpcodeV12.ARRAY_U16_LOAD => instEmitter.EmitArrayU16Load(u16(0)),
            OpcodeV12.ARRAY_U16_STORE => instEmitter.EmitArrayU16Store(u16(0)),
            OpcodeV12.LOCAL_U16 => instEmitter.EmitLocalU16(u16(0)),
            OpcodeV12.LOCAL_U16_LOAD => instEmitter.EmitLocalU16Load(u16(0)),
            OpcodeV12.LOCAL_U16_STORE => instEmitter.EmitLocalU16Store(u16(0)),
            OpcodeV12.STATIC_U16 => instEmitter.EmitStaticU16(u16(0)),
            OpcodeV12.STATIC_U16_LOAD => instEmitter.EmitStaticU16Load(u16(0)),
            OpcodeV12.STATIC_U16_STORE => instEmitter.EmitStaticU16Store(u16(0)),
            OpcodeV12.GLOBAL_U16 => instEmitter.EmitGlobalU16(u16(0)),
            OpcodeV12.GLOBAL_U16_LOAD => instEmitter.EmitGlobalU16Load(u16(0)),
            OpcodeV12.GLOBAL_U16_STORE => instEmitter.EmitGlobalU16Store(u16(0)),
            OpcodeV12.J => instEmitter.EmitJ(s16(0)),
            OpcodeV12.JZ => instEmitter.EmitJZ(s16(0)),
            OpcodeV12.IEQ_JZ => instEmitter.EmitIEqJZ(s16(0)),
            OpcodeV12.INE_JZ => instEmitter.EmitINeJZ(s16(0)),
            OpcodeV12.IGT_JZ => instEmitter.EmitIGtJZ(s16(0)),
            OpcodeV12.IGE_JZ => instEmitter.EmitIGeJZ(s16(0)),
            OpcodeV12.ILT_JZ => instEmitter.EmitILtJZ(s16(0)),
            OpcodeV12.ILE_JZ => instEmitter.EmitILeJZ(s16(0)),
            OpcodeV12.CALL => instEmitter.EmitCall(u24(0)),
            OpcodeV12.STATIC_U24 => instEmitter.EmitStaticU24(u24(0)),
            OpcodeV12.STATIC_U24_LOAD => instEmitter.EmitStaticU24Load(u24(0)),
            OpcodeV12.STATIC_U24_STORE => instEmitter.EmitStaticU24Store(u24(0)),
            OpcodeV12.GLOBAL_U24 => instEmitter.EmitGlobalU24(u24(0)),
            OpcodeV12.GLOBAL_U24_LOAD => instEmitter.EmitGlobalU24Load(u24(0)),
            OpcodeV12.GLOBAL_U24_STORE => instEmitter.EmitGlobalU24Store(u24(0)),
            OpcodeV12.PUSH_CONST_U24 => instEmitter.EmitPushConstU24(u24(0)),
            OpcodeV12.SWITCH => instEmitter.EmitSwitch(switchOps()),
            OpcodeV12.STRING => instEmitter.EmitString(),
            OpcodeV12.STRINGHASH => instEmitter.EmitStringHash(),
            OpcodeV12.TEXT_LABEL_ASSIGN_STRING => instEmitter.EmitTextLabelAssignString(u8(0)),
            OpcodeV12.TEXT_LABEL_ASSIGN_INT => instEmitter.EmitTextLabelAssignInt(u8(0)),
            OpcodeV12.TEXT_LABEL_APPEND_STRING => instEmitter.EmitTextLabelAppendString(u8(0)),
            OpcodeV12.TEXT_LABEL_APPEND_INT => instEmitter.EmitTextLabelAppendInt(u8(0)),
            OpcodeV12.TEXT_LABEL_COPY => instEmitter.EmitTextLabelCopy(),
            OpcodeV12.CATCH => instEmitter.EmitCatch(),
            OpcodeV12.THROW => instEmitter.EmitThrow(),
            OpcodeV12.CALLINDIRECT => instEmitter.EmitCallIndirect(),
            OpcodeV12.PUSH_CONST_M1 => instEmitter.EmitPushConstM1(),
            OpcodeV12.PUSH_CONST_0 => instEmitter.EmitPushConst0(),
            OpcodeV12.PUSH_CONST_1 => instEmitter.EmitPushConst1(),
            OpcodeV12.PUSH_CONST_2 => instEmitter.EmitPushConst2(),
            OpcodeV12.PUSH_CONST_3 => instEmitter.EmitPushConst3(),
            OpcodeV12.PUSH_CONST_4 => instEmitter.EmitPushConst4(),
            OpcodeV12.PUSH_CONST_5 => instEmitter.EmitPushConst5(),
            OpcodeV12.PUSH_CONST_6 => instEmitter.EmitPushConst6(),
            OpcodeV12.PUSH_CONST_7 => instEmitter.EmitPushConst7(),
            OpcodeV12.PUSH_CONST_FM1 => instEmitter.EmitPushConstFM1(),
            OpcodeV12.PUSH_CONST_F0 => instEmitter.EmitPushConstF0(),
            OpcodeV12.PUSH_CONST_F1 => instEmitter.EmitPushConstF1(),
            OpcodeV12.PUSH_CONST_F2 => instEmitter.EmitPushConstF2(),
            OpcodeV12.PUSH_CONST_F3 => instEmitter.EmitPushConstF3(),
            OpcodeV12.PUSH_CONST_F4 => instEmitter.EmitPushConstF4(),
            OpcodeV12.PUSH_CONST_F5 => instEmitter.EmitPushConstF5(),
            OpcodeV12.PUSH_CONST_F6 => instEmitter.EmitPushConstF6(),
            OpcodeV12.PUSH_CONST_F7 => instEmitter.EmitPushConstF7(),
            OpcodeV12.IBITTEST => instEmitter.EmitIBitTest(),
    ...
    private void FixInstruction(InstructionReference instruction, ImmutableArray<Parser.InstructionOperand> operands)
    {
        ...
        _ = opcode switch
        {
            OpcodeV12.PUSH_CONST_U8 => instEmitter.EmitPushConstU8(u8(0, 1)),
            OpcodeV12.PUSH_CONST_U8_U8 => instEmitter.EmitPushConstU8U8(u8(0, 1), u8(1, 2)),
            OpcodeV12.PUSH_CONST_U8_U8_U8 => instEmitter.EmitPushConstU8U8U8(u8(0, 1), u8(1, 2), u8(2, 3)),
            OpcodeV12.PUSH_CONST_U32 => instEmitter.EmitPushConstU32(u32(0, 1)),
            OpcodeV12.NATIVE => instEmitter.EmitNative(u8NoCodeLabels(0), u8NoCodeLabels(1), u16NoCodeLabels(2)),
            OpcodeV12.ENTER => instEmitter.EmitEnter(u8(0, 1), u16(1, 2), opcode.GetEnterFunctionName(CollectionsMarshal.AsSpan(instBuffer.GetBytes(instruction)))),
            OpcodeV12.LEAVE => instEmitter.EmitLeave(u8(0, 1), u8(1, 1)),
            OpcodeV12.ARRAY_U8 => instEmitter.EmitArrayU8(u8(0, 1)),
            OpcodeV12.ARRAY_U8_LOAD => instEmitter.EmitArrayU8Load(u8(0, 1)),
            OpcodeV12.ARRAY_U8_STORE => instEmitter.EmitArrayU8Store(u8(0, 1)),
            OpcodeV12.LOCAL_U8 => instEmitter.EmitLocalU8(u8(0, 1)),
            OpcodeV12.LOCAL_U8_LOAD => instEmitter.EmitLocalU8Load(u8(0, 1)),
            OpcodeV12.LOCAL_U8_STORE => instEmitter.EmitLocalU8Store(u8(0, 1)),
            OpcodeV12.STATIC_U8 => instEmitter.EmitStaticU8(u8(0, 1)),
            OpcodeV12.STATIC_U8_LOAD => instEmitter.EmitStaticU8Load(u8(0, 1)),
            OpcodeV12.STATIC_U8_STORE => instEmitter.EmitStaticU8Store(u8(0, 1)),
            OpcodeV12.IADD_U8 => instEmitter.EmitIAddU8(u8(0, 1)),
            OpcodeV12.IMUL_U8 => instEmitter.EmitIMulU8(u8(0, 1)),
            OpcodeV12.IOFFSET_U8 => instEmitter.EmitIOffsetU8(u8(0, 1)),
            OpcodeV12.IOFFSET_U8_LOAD => instEmitter.EmitIOffsetU8Load(u8(0, 1)),
            OpcodeV12.IOFFSET_U8_STORE => instEmitter.EmitIOffsetU8Store(u8(0, 1)),
            OpcodeV12.PUSH_CONST_S16 => instEmitter.EmitPushConstS16(s16(0, 1)),
            OpcodeV12.IADD_S16 => instEmitter.EmitIAddS16(s16(0, 1)),
            OpcodeV12.IMUL_S16 => instEmitter.EmitIMulS16(s16(0, 1)),
            OpcodeV12.IOFFSET_S16 => instEmitter.EmitIOffsetS16(s16(0, 1)),
            OpcodeV12.IOFFSET_S16_LOAD => instEmitter.EmitIOffsetS16Load(s16(0, 1)),
            OpcodeV12.IOFFSET_S16_STORE => instEmitter.EmitIOffsetS16Store(s16(0, 1)),
            OpcodeV12.ARRAY_U16 => instEmitter.EmitArrayU16(u16(0, 1)),
            OpcodeV12.ARRAY_U16_LOAD => instEmitter.EmitArrayU16Load(u16(0, 1)),
            OpcodeV12.ARRAY_U16_STORE => instEmitter.EmitArrayU16Store(u16(0, 1)),
            OpcodeV12.LOCAL_U16 => instEmitter.EmitLocalU16(u16(0, 1)),
            OpcodeV12.LOCAL_U16_LOAD => instEmitter.EmitLocalU16Load(u16(0, 1)),
            OpcodeV12.LOCAL_U16_STORE => instEmitter.EmitLocalU16Store(u16(0, 1)),
            OpcodeV12.STATIC_U16 => instEmitter.EmitStaticU16(u16(0, 1)),
            OpcodeV12.STATIC_U16_LOAD => instEmitter.EmitStaticU16Load(u16(0, 1)),
            OpcodeV12.STATIC_U16_STORE => instEmitter.EmitStaticU16Store(u16(0, 1)),
            OpcodeV12.GLOBAL_U16 => instEmitter.EmitGlobalU16(u16(0, 1)),
            OpcodeV12.GLOBAL_U16_LOAD => instEmitter.EmitGlobalU16Load(u16(0, 1)),
            OpcodeV12.GLOBAL_U16_STORE => instEmitter.EmitGlobalU16Store(u16(0, 1)),
            OpcodeV12.J => instEmitter.EmitJ(s16(0, 1)),
            OpcodeV12.JZ => instEmitter.EmitJZ(s16(0, 1)),
            OpcodeV12.IEQ_JZ => instEmitter.EmitIEqJZ(s16(0, 1)),
            OpcodeV12.INE_JZ => instEmitter.EmitINeJZ(s16(0, 1)),
            OpcodeV12.IGT_JZ => instEmitter.EmitIGtJZ(s16(0, 1)),
            OpcodeV12.IGE_JZ => instEmitter.EmitIGeJZ(s16(0, 1)),
            OpcodeV12.ILT_JZ => instEmitter.EmitILtJZ(s16(0, 1)),
            OpcodeV12.ILE_JZ => instEmitter.EmitILeJZ(s16(0, 1)),
            OpcodeV12.CALL => instEmitter.EmitCall(u24(0, 1)),
            OpcodeV12.STATIC_U24 => instEmitter.EmitStaticU24(u24(0, 1)),
            OpcodeV12.STATIC_U24_LOAD => instEmitter.EmitStaticU24Load(u24(0, 1)),
            OpcodeV12.STATIC_U24_STORE => instEmitter.EmitStaticU24Store(u24(0, 1)),
            OpcodeV12.GLOBAL_U24 => instEmitter.EmitGlobalU24(u24(0, 1)),
            OpcodeV12.GLOBAL_U24_LOAD => instEmitter.EmitGlobalU24Load(u24(0, 1)),
            OpcodeV12.GLOBAL_U24_STORE => instEmitter.EmitGlobalU24Store(u24(0, 1)),
            OpcodeV12.PUSH_CONST_U24 => instEmitter.EmitPushConstU24(u24(0, 1)),
            OpcodeV12.SWITCH => instEmitter.EmitSwitch(switchOps()),
            OpcodeV12.TEXT_LABEL_ASSIGN_STRING => instEmitter.EmitTextLabelAssignString(u8(0, 1)),
            OpcodeV12.TEXT_LABEL_ASSIGN_INT => instEmitter.EmitTextLabelAssignInt(u8(0, 1)),
            OpcodeV12.TEXT_LABEL_APPEND_STRING => instEmitter.EmitTextLabelAppendString(u8(0, 1)),
            OpcodeV12.TEXT_LABEL_APPEND_INT => instEmitter.EmitTextLabelAppendInt(u8(0, 1)),
    ...
    public readonly struct Instruction
    {
        ...
        public OpcodeV12 Opcode { get; }
        public int Offset { get; }
        public int Length { get; }

        public Instruction(Parser.Instruction instruction, OpcodeV12 opcode, int offset, int length)
        {
    ...
    private sealed class CodeBuilder
    {
        ...
        public void Opcode(OpcodeV12 v) => U8((byte)v);
        ...
        public (int InstructionOffset, int InstructionLength) Flush()
        {
            ...
            OpcodeV12 opcode = (OpcodeV12)buffer[0];
