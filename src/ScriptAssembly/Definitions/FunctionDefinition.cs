namespace ScTools.ScriptAssembly.Definitions
{
    ...
    public sealed class FunctionDefinition : ISymbolDefinition
    {
        ...
        public FunctionDefinition(string name, bool naked, IEnumerable<FieldDefinition> args, IEnumerable<FieldDefinition> locals, IEnumerable<Statement> statements)
        {
            ...
            if (Naked && (Args.Length > 0 || Locals.Length > 0))
            {
